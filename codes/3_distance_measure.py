...
awmr_mesh_path = f'../0926_results/[TSDF]{dataset_name}/SingleRes/voxsize_{finest_voxel_size:.6f}/original/{dataset_name}_singleres=[32 32 32].ply'
...
# awmr_mesh_path = f'../0926_results/[TSDF]{dataset_name}/SingleRes/voxsize_{finest_voxel_size:.6f}/original/{dataset_name}_singleres=[8 8 8].ply'
