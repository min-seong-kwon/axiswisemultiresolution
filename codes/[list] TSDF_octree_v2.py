...
base_path = f'../1018_results/[TSDF]{dataset_name}/octree/voxsize_{finest_voxel_size:.6f}/'
...
for thres in thres_list:
    ...
    file_format = f'{dataset_name}_octree_thres={thres2str}'
...
print(data)
data.to_excel(f'../1018_results/[TSDF]{dataset_name}/octree/voxsize_{finest_voxel_size:.6f}/RD_{dataset_name}_octree.xlsx', index=True)