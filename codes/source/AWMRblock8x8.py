# -*- coding: utf-8 -*-
"""
Created on Mon Dec 05 13:01:01 2022
...
class VolumeUnit8x8(VolumeUnit):
    # using the existing VolumeUnit class, just in case
    def __init__(self, tsdf=None, mask=None):
        super().__init__(volume_unit_dim=8, depth=np.nan)
        self.D = tsdf
        self.M = mask
        return
    

class AWMRblock8x8(Node):
    def __init__(self, 
                 axisres,
                 unit_index,
                 left=None, 
        ...
        self.tsdf = VolumeUnit8x8(tsdf=tsdf)
